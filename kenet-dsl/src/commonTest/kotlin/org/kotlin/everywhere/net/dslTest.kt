...
class DslTest {
    ...
    fun testEndpointInitialized() {
        ...
        assertFalse(api._endpoints[1].initialized, "호출하지 않은 상태에서는 초기화되기 전이다.")
        ...
        assertEquals("anonymousEndpoint#1", api._endpoints[1].name, "초기화 전에는 anonymous#index 형식의 이름을 가지고 있어야 한다.")
